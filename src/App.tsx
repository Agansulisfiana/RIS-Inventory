    ...
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans text-slate-900 antialiased selection:bg-blue-600 selection:text-white">
          ...
          <header className="h-16 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between gap-4 shrink-0 z-20">
            ...
            <div className="flex items-center gap-3 flex-1 max-w-xl">
              ...
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Cari master produk, serial number, SKU, barcode..."
                  value={globalSearch}
                ...
                {isSearchFocused && searchResults.length > 0 && (
                  <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-slate-200 rounded-xl shadow-xl p-2 z-50 space-y-1">
                    ...
                    {searchResults.map((item) => (
                      <div
                        ...
                        className="p-2 hover:bg-blue-50 rounded-lg flex items-center justify-between cursor-pointer"
                      >
                        <div>
                          <div className="font-bold text-xs text-slate-900">{item.name}</div>
                          <div className="font-mono text-[10px] text-blue-600">SKU: {item.sku} • SN: {item.serialNumber}</div>
                        </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="relative">
                ...
                {isNotificationOpen && (
                  <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-slate-200 rounded-2xl shadow-xl p-3 z-50 space-y-2">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex">
          <div className="w-72 bg-white h-full p-4 flex flex-col justify-between">
            ...
            <button
              ...
              className="w-full py-2 bg-rose-50 text-rose-600 text-xs font-bold rounded-xl flex items-center justify-center gap-2"
            >
              <LogOut className="w-4 h-4" />
