    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          ...
          <div className="flex items-center justify-between md:justify-start gap-2 w-full md:w-auto">
            <select
              ...
              className="bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-bold text-slate-700 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none flex-1 md:flex-initial"
            >
              {categories.map(cat => (
      ...
      {viewMode === 'table' ? (
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
          ...
          <div className="sm:hidden px-3.5 py-2 bg-blue-50/80 border-b border-blue-100 flex items-center justify-between text-[11px] text-blue-700 font-medium">
            <span>👉 Geser tabel ke kanan untuk melihat stok & aksi</span>
            <span className="font-bold bg-white px-2 py-0.5 rounded border border-blue-200 text-[10px]">Scroll &rarr;</span>
          </div>
          <div className="overflow-x-auto">
            <table className="catalog-table min-w-[1100px] w-full text-left text-xs table-fixed">
